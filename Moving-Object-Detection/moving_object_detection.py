...
## [capture]
video_path = "C:/Users/ssdff/msor semester 1/ieor4004\hw7/110453002-1-6_Trim.mp4"
output_folder = "C:/Users/ssdff/msor semester 1/ieor4004/hw7"
...
for i in range(epoch_ceil):
	...
	for j in tqdm(range(num_batch)):
		...
		for t in range(j*batch_size, (j+1)*batch_size):
            ...
            ################################################################
            ########## Write stochastic gradient method update here ########
